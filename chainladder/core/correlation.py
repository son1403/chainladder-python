...
class DevelopmentCorrelation:
    ...
    def __init__(self, triangle, p_critical: float = 0.5):
        ...
        # n_periods is the number of development periods in the triangle (I in Mack 1997)
        n_periods = len(triangle.development)
        ...
        denominator = ((n_periods - k) ** 3 - n_periods + k)[None, None, None]
        ...
        weight = (n_periods - k - 1)[None, None, None]
        ...
        self.t_variance = 2 / ((n_periods - 2) * (n_periods - 3))
